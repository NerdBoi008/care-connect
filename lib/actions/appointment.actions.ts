...
export async function getAppointment(appointmentId: string): CreateAppointmentParams {
    try {
...
export async function updateAppointment({ appointmentId, userId, appointment, type }: UpdateAppointmentParams) {
    try {
